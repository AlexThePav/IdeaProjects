"""Modify the program so that the class structure matches the simplified diagram: Artist objects can hold
    references to Album objects, and Album objects can hold references to Song objects but there must be
...
class Artist:
    ...
    def add_song(self, name, year, title):
        ...
        A new album will be created in the colelction if it doesn't already exist.
